      ...
      <a-form :model="form" ref="formRef">
        <a-tabs v-model:active-key="activeTab">
          ...
          <a-tab-pane title="字段配置" key="field_config">
            ...
            <a-table :data="form.columns" :pagination="false" class="mt-3" @change="handleChange" :draggable="{ type: 'handle', width: 40 }">
              <template #columns>
                ...
                <a-table-column dataIndex="column_width" title="列表宽度" :width="100">
                  <template #cell="{ rowIndex }"><a-input-number v-model="form.columns[rowIndex].column_width" /></template>
                </a-table-column>
